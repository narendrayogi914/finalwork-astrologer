...
function adjustSearchPosition() {
  ...
  if (window.innerWidth < 955) {
    ...
    searchIcon.onclick = () => {
      ...
      searchInput.style.width = "215px"; // Initially, the input field is hidden
...
const canadaItems = [
  ...
  {
    name: "Vancouver",
    href: "Astrologer-in-Vancouver-British-Columbia-Canada.html",
  },
  ...
  { name: "Alberta", href: "Astrologer-in-Alberta-Canada.html" },
  {
    ...
    href: "Astrologer-in-British-Columbia-Canada.html",
  },
  {
    name: "Victoria",
    href: "Astrologer-in-Victoria-British-Columbia-Canada.html",
  },
  ...
  {
    name: "Mississauga",
    href: "Astrologer-in-Mississauga-Ontario-Canada.html",
  },
  ...
  {
    name: "Scarborough",
    href: "Astrologer-in-Scarborough-Ontario-Canada.html",
  },
...
function searchbarsection() {
  ...
  const suggestions = [
    {
      url: "https://mastervijayram.blogspot.com/2023/07/blog-post_25.html",
      title: "Embrace Healing",
      image: "https://via.placeholder.com/50",
    },
    {
      url: "https://mastervijayram.blogspot.com/2023/07/blog-post_31.html",
      title: "Encounter the transformative power ",
      image: "https://via.placeholder.com/50",
    },
    {
      url: "https://mastervijayram.blogspot.com/2023/08/blog-post.html",
      title:
        "Best Indian Astrologer in Toronto: Unlock Cosmic Wisdom with Vijay Ram",
      image: "https://via.placeholder.com/50",
    },
    {
      url: "https://mastervijayram.blogspot.com/2023/07/Expert%20Astrologer%20in%20North%20York.html",
      title: "Astrology services north-york",
      image: "https://via.placeholder.com/50",
    },
    {
      url: "https://mastervijayram.blogspot.com/2022/10/black-magic-removal-specialist-services.html",
      title: "Black magic",
      image: "https://via.placeholder.com/50",
    },
  ];
  ...
  function ShowSomeDefaultItem() {
    ...
    suggestions.slice(0, 3).forEach((suggestion) => {
      const li = document.createElement("li");
      // li.classList.add("list-group-item", "d-flex", "text-align-center");
  ...
  searchInput.addEventListener("input", () => {
    ...
    const filteredSuggestions = suggestions.filter((suggestion) =>
      suggestion.title.toLowerCase().startsWith(query)
    );
